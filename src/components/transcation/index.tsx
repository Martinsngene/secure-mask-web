...
function Transaction() {
  const { transactionStatus, txId, transactionInProgress }: any =
    useTransaction();
  ...
  const Approval = () => {
    return (
      <div>
        ...
        <progress data-indeterminate='true'>Initializing...</progress>
      </div>
    );
  };
  ...
  const Pending = () => {
    return (
      <div>
        ...
        <progress data-indeterminate='true'>Executing</progress>
      </div>
    );
  };
  ...
  const Finalized = () => {
    return (
      <div>
        ...
        <progress data-min='0' max='100' value='80'>
          Executing...
        </progress>
      </div>
    );
  ...
  const Sealed = () => {
    return (
      <div>
        ...
        <progress data-min='0' max='100' value='100'>
          Sealed!
        </progress>
      </div>
    );

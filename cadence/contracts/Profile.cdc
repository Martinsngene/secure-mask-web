...
-----------
    ...
    import Profile from 0x1868ccdfcc69a0dc
...
-------
    ...
    await query({
      ...
      `,
      args: (arg, t) => [
        arg("0x1868ccdfcc69a0dc", t.Address)
      ]
    })
...
-------
    ...
    await query({
      ...
      `,
      args: (arg, t) => [
        arg(["0x1868ccdfcc69a0dc", "0xf76a4c54f0f75ce4", "0xf117a8efa34ffd58"], t.Array(t.Address)),
      ]
    })
...
pub contract Profile {
  ...
  pub resource Base: Owner, Public {
    ...
    init() {
      self.name = "Martins"
      self.avatar = "https://lh3.googleusercontent.com/a/AAcHTtdQ1TV8MhkMq4noI5VqfL2rTiMSmozk1_LOCPDp=s288-c-no"
      self.color = "#87CEEB"
      self.info = "I'm a FullStack & Blockchain Developer"
    }
